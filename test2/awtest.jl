...
df4 = DataFrame(aw=aw, k=k, comp="Phenol")

components = [("HCOOH", 1)]
AIOMFAC.writeinput("input_0005.txt", Tk, components, 1.0)
run(`./AIOMFAC Inputfiles/input_0005.txt`)
aw, k = AIOMFAC.parseoutput("AIOMFAC_output_0005.txt")
df4 = DataFrame(aw=aw, k=k, comp="Formic Acid")
